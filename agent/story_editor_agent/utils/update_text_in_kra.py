...
from ..utils.svg_retriever import krita_file_name_safe
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                ...
                doc_name = krita_file_name_safe(doc)
...
def update_svg_text(svg_content, new_text):
    ...
    try:
        ...
        # Reconstruct the SVG
        updated_svg = svg_content[:text_start] + new_content + svg_content[text_end:]
        return updated_svg
